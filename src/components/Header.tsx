  ...
  return (
    <div className="flex justify-start w-full absolute top-0 z-10 mx-auto border-b border-[rgba(255,255,255,0.25)]">
      <div className="flex items-center  ml-4 mr-4 md:ml-[200px] md:mr-[353px]">
         <img src={Logo} className="w-full h-[70px] md:h-[93px]" alt="Logo" />
      </div>
      <div className="flex gap-[10px] md:gap-[64px] justify-center items-center text-white text-sm md:text-lg font-light leading-6">
